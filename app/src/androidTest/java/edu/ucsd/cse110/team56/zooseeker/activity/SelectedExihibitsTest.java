...
public class SelectedExihibitsTest {
    ...
    @Test
    public void selectedExihibitsTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.added_count), withText("Added: 5 Visited: 0"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class))),
                        isDisplayed()));
        textView.check(matches(withText("Added: 5 Visited: 0")));

        DataInteraction materialTextView = onData(anything())
                .inAdapterView(allOf(withId(R.id.added_list),
                        childAtPosition(
