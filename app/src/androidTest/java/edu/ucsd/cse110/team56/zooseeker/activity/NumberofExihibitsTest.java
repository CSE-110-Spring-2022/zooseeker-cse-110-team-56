...
public class NumberofExihibitsTest {
    ...
    @Test
    public void numberofExihibitsTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.added_count), withText("Added: 3 Visited: 0"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class))),
                        isDisplayed()));
        textView.check(matches(withText("Added: 3 Visited: 0")));
