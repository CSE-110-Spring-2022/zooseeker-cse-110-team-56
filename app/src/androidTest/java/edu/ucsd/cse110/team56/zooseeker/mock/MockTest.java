...
public class MockTest {
    ...
    public void mockTest() throws InterruptedException {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.latitude),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("32.750121730961744"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.longitude),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("-117.16626781198585"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.direction_text), withText("Arrive at Capuchin Monkeys "),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class))),
                        isDisplayed()));

        Thread.sleep(1500);

        textView.check(matches(withText("Arrive at Capuchin Monkeys ")));
/*        try {
            textView.check(matches(withText("Arrive at Capuchin Monkeys ")));
        ...
        ViewInteraction materialButtonClear = onView(
                allOf(withId(R.id.clear_btn), withText("Clear"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        materialButtonClear.perform(click());
    }
