...
public class SkipReplanTest {
    ...
    @Test
    public void skipReplanTest() throws InterruptedException {
...
allOf(withId(R.id.exhibit_planed), withText("Gorillas"),
...
0),
isDisplayed()));
        appCompatEditText.perform(replaceText("32.744"), closeSoftKeyboard());
...
1),
isDisplayed()));
        appCompatEditText2.perform(replaceText("-117.157"), closeSoftKeyboard());
...
isDisplayed()));
        textView3.check(matches(withText("Next: Capuchin Monkeys")));

        ViewInteraction textView4 = onView(
allOf(withId(R.id.direction_text), withText("Proceed on Monkey Trail 3100.0 ft towards Capuchin Monkeys "),
withParent(withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class))),
isDisplayed()));
        textView4.check(matches(withText("Proceed on Monkey Trail 3100.0 ft towards Capuchin Monkeys ")));
